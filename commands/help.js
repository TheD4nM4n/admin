    ...
    const embed = {
      ...
      fields: [
        ...
        },
        {
          ...
          value: `Unfortunately, no. dash commands have been removed with the advent of slash commands. All of the original functionality (and more!) is still intact, so you aren't missing out on anything!`,
          inline: false,
        },
        {
